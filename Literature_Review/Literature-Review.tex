...
\abstract{This is a first report detailing what I've been up to over my first 9 months as a PhD student and laying out the path that will be taken from here going forwards.}
...
\begin{figure}[!htp]
\centering
\includegraphics[width=0.8\textwidth]{filters.jpg}
...
\begin{figure}[!htp]
\centering
\includegraphics[width=0.5\textwidth]{KMOS_SPEC_OBS258_0009_Corrected110_temp_spline3_CorrelationGraph.png}
\includegraphics[width=0.5\textwidth]{KMOS_SPEC_OBS258_0009_Corrected110_temp_linear_CorrelationGraph.png}
